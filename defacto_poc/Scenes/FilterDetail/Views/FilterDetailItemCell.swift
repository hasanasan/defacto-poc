...
// MARK: - FilterDetailItemCell -

final class FilterDetailItemCell: UITableViewCell {
    // MARK: - Lifecycle -
    ...
    func configure(viewModel: FilterDetailItemCellViewModel) {
...
// MARK: - FilterDetailItemCellViewModel -

struct FilterDetailItemCellViewModel {
    let id: String?
    let title: String?
    var isSelected: Bool
}
